        ...
        >
            ...
            <div className="mb-3 min-w-0 overflow-hidden">
                ...
                <input
                    ...
                    className="appearance-none box-border h-8 w-full max-w-full min-w-0 cursor-pointer rounded border border-slate-500 bg-white px-1 text-[10px] text-slate-900 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-100 sm:text-sm"
                />
            </div>
